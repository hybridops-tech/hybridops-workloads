...
ACADEMY_STRIPE_PRICE_ID_DOCS_MONTHLY="${ACADEMY_STRIPE_PRICE_ID_DOCS_MONTHLY:-}"
ACADEMY_STRIPE_PRICE_ID_DOCS_YEARLY="${ACADEMY_STRIPE_PRICE_ID_DOCS_YEARLY:-}"
...
export ACADEMY_STRIPE_PRICE_ID_DOCS_MONTHLY='${ACADEMY_STRIPE_PRICE_ID_DOCS_MONTHLY}'
export ACADEMY_STRIPE_PRICE_ID_DOCS_YEARLY='${ACADEMY_STRIPE_PRICE_ID_DOCS_YEARLY}'
...
stringData:
  ...
  STRIPE_PRICE_ID_DOCS_MONTHLY: "${ACADEMY_STRIPE_PRICE_ID_DOCS_MONTHLY}"
  STRIPE_PRICE_ID_DOCS_YEARLY: "${ACADEMY_STRIPE_PRICE_ID_DOCS_YEARLY}"
